...
/// V5 migration — EPUB block and alignment anchor tables for manual
/// EPUB/audio alignment, plus nullable timeline_item columns for
/// timestamp source tracking.
enum Schema_V5 {
    static func migrate(_ db: Database) throws {
        // EPUB block structure
        ...
        // Extend timeline_item with alignment tracking columns
